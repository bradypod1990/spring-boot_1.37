...
public class DynamicDataSourcePool {
	...
	private Logger logger = Logger.getLogger(DynamicDataSourcePool.class);
	...
	public DynamicDataSourcePool(String username, String mmpd, String url, String driverClassName, int initialSize,
		...
		try {
			...
			this.dataSourcePool.setPassword(mmpd);
	 ...
	 * @throws Exception
	 */
	public DynamicDataSourcePool(String driverClassName, String url, String mmpd, String username) throws Exception {
...
//			}
			this.dataSourcePool.setMaxActive(10); // 最大激活连接数
			this.dataSourcePool.setMaxIdle(10); // 最大闲置连接数
